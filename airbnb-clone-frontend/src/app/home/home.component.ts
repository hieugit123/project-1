...
import {CardListing, DisplayPicture} from "../landlord/model/listing.model";
...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  // priceVO: PriceVO = {value: 0};

  // cateName : CategoryName = "AMAZING_VIEWS";
  ...
  constructor() {
    ...
    //     location: "Viet Nam",
    //     cover: this.picture,
    //     bookingCategory: this.cateName,
    //     publicId: "Mai Xuan Hieu",
    //     loading: false
    //   },
    //   {
    //     price: this.priceVO,
